class Level
  ...
  def add_effect effect
    @effects_to_add << effect
  end

  def remove_effect effect
    @effects_to_destroy << effect
  end
  ...
  def simulate args
    ...
    # effects
    # add new ones
    @effects.concat(@effects_to_add)
    @effects_to_add.clear
    # destroy old ones
    @effects -= @effects_to_destroy
    @effects_to_destroy.clear
  ...
  def draw args
    ...
    @effects.each do |effect|
      effect.draw(args.state.tick_count)
    end
